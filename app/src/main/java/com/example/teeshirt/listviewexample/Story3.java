...
public class Story3 extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView story3 = (TextView)findViewById(R.id.story3);
        story3.setText(readTxt());
        Typeface font = Typeface.createFromAsset(getAssets(), "opensans.ttf");
        story3.setTypeface(font);
    }

    private String readTxt(){
        InputStream inputStream = getResources().openRawResource(R.raw.story3);
